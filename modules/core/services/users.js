export default (client) => {
  return {
    ...
    create(values) {
      return client.post('/custom/user/', values)
    },
    createUser(values) {
      return client.post('/custom/group-user/', values)
    },
    update(id, values) {
      return client.patch(`/custom/user/${id}/`, values)
    },
    leave(id) {
      return client.post(`/groups/${id}/leave/`)
    },
    delete(id) {
      return client.delete(`/custom/user/${id}/`)
    },
